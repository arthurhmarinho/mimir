...
- [x] **Login Automatizado:** Autenticação segura no portal do aluno.
- [x] **Extração de Horários:** Identificação de aulas, salas e horários.
...
```bash
# Clone o repositório
git clone [https://github.com/SEU-USUARIO/NOME-DO-PROJETO.git](https://github.com/SEU-USUARIO/NOME-DO-PROJETO.git)](https://github.com/arthurhmarinho/mimir.git)
cd server
